...
public class BlockBunsenBurner extends BlockContainer {

	public BlockBunsenBurner(int id, Material par2material) {
	...
	public boolean onBlockActivated(World world, int x, int y, int z,
		...
		player.openGui(Chemistryzation.instance, 0, world, x, y, z);
		return true;
	}
